#!/bin/bash
# ============================================================================
#  CloudPanel Performance Optimizer v3.1
...
create_backups() {
    ...
    mkdir -p "$BACKUP_DIR"/{mysql,php,redis,system}
...
optimize_redis() {
    ...
    # Persistence kept ON \u2014 SaaS apps may use Redis for queues/sessions
    # To disable for cache-only use: uncomment next line
    # redis_set "save" '""'
...
case "${1:-}" in
    ...
    --help|-h)
        echo ""
        echo "  CloudPanel Performance Optimizer v3.1"
        echo ""
        echo "  Usage:"
...
echo -e "${GREEN}${BOLD}\u2551         CloudPanel Performance Optimizer v3.1                 \u2551${NC}"
